...
try_read_key_fd(int fildes) {
  ...
  switch ((ch = rl_xgetchr(fildes))) {
    ...
    case CTRL('s'): return (RL_KEY_EOF);
    case CTRL('a'): return (RL_KEY_HOME);
    case CTRL('e'): return (RL_KEY_END);
    case CTRL('b'): return (RL_KEY_WORDLEFT);
    case CTRL('n'): return (RL_KEY_WORDRIGHT);
    case CTRL('w'): return (RL_KEY_ADDLINE);
    case CTRL('x'): return (RL_KEY_REMLINE);
    case CTRL('l'): return (RL_KEY_CLEAR_SCREEN);
    case CTRL('p'): return (RL_KEY_START_EDITOR);
    ...
    case 27:
      ...
      switch ((ch = rl_xgetchr(fildes))) {
        ...
        case '[':
          ...
          switch ((ch = rl_xgetchr(fildes))) { 
            case -1:  return (-1);
            case 'A': return (RL_KEY_UP);
            case 'B': return (RL_KEY_DOWN);
            case 'D': return (RL_KEY_LEFT);
            case 'C': return (RL_KEY_RIGHT);
            /*
