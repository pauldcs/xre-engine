...
const char *error_class_str(error_class_e class) {
    switch (class) {
        case XRE_MEMORY_ERROR_C:      return "Memory Error";
        case XRE_ARITHMETIC_ERROR_C:  return "Arithmetic Error";
        case XRE_INTERNAL_ERROR_C:    return "Internal Error";
        case XRE_INDEX_ERROR_C:       return "Index Error";
        case XRE_NAME_ERROR_C:        return "Name Error";
        case XRE_ACCESS_ERROR_C:      return "Access Error";
        case XRE_TERMINATION_ERROR_C: return "Termination Error";
        case XRE_RUNTIME_ERROR_C:     return "Runtime error";
        case XRE_SYNTAX_ERROR_C:      return "Syntax Error";
        case XRE_TYPE_ERROR_C:        return "Type Error";
        case XRE_VALUE_ERROR_C:       return "Value Error";
    }
...
const char *error_type_str(error_type_e type) {
    switch (type) {
        ...
        case XRE_UNDEFINED_BEHAVIOR_ERROR:      return "undefined behavior happened";
        case XRE_OUT_OF_MEMORY_ERROR:         return "out of memory";
        case XRE_MAX_ITERATIONS_ERROR:         return "max iterations reached";
        case XRE_MODE_WRITE_ON_STRICT_ERROR: return "attempt to write on a protected variable";
        case XRE_WRITE_ON_READONLY_ERROR:    return "attempt to write on a readonly variable";
        ...
        case XRE_TYPE_MISSMATCH_ERROR:    return "missmatching types";
        ...
        case XRE_INVALID_TYPE_FOR_OPERAND_ERROR: return "operator unsupported for this type";
        case XRE_UNBOUND_LOCAL_ERROR:     return "unbound local variable";
        case XRE_OUT_OF_BOUNDS_ACCESS_ERROR:     return "out of bounds access";
        ...
        case XRE_UNEXPECTED_OPERATOR_ERROR:     return "unexpected operator";
        case XRE_UNEXPECTED_OPERAND_ERROR:      return "unexpected operand";
        case XRE_UNMATCHED_PARENTHESIS_ERROR:   return "unmatched parenthesis";
        case XRE_UNTERMINATED_STRING_ERROR: return "unterminated string";
    }
