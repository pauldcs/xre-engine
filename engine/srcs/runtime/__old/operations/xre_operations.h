...
bool binop_evaluate_pop_r(
	struct statements *self,
	object_t	  *left_buffer,
	object_t	  *right_buffer
);

bool stack_pop_r(object_t *ptr, struct statements *stmts);
...
bool stack_push_enable_attrs(
	struct statements *self, object_t *object, int32_t attrs
);
void set_current_error(struct statements *self, error_type_e type);

bool unwrap_number_object(
	struct statements *self, object_t *object, int64_t *data
);
bool unwrap_symbol_read(
	struct statements *self, int64_t offset, object_t **object
);
bool unwrap_symbol_write(
	struct statements *self, int64_t offset, object_t **object
);

#define XRE_API(name) bool name(struct statements *self)
typedef bool (*fptr_t)(struct statements *self);
