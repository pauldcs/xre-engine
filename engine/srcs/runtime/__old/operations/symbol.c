...
//  */
// static inline bool
// _oper_symbol_expand(struct statements *self, object_t *object)
// {
...
//  */
// static inline bool
// _oper_symbol_addr(struct statements *self, object_t *object)
// {
// 	object_symbol_init(self->value, object);
// 	return (__push_r(self, object));
// }

static inline bool _oper_symbol(struct statements *self)
{
