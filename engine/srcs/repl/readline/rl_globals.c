...
const uint16_t _CharType[256] = {
	0,   _BB, _BB, _BB, _BB, _BB, _BB, _BB, _BB, _CN, _CN, _CN,
	_CN, _CN, _BB, _BB, _BB, _BB, _BB, _BB, _BB, _BB, _BB, _BB,
	_BB, _BB, _BB, _BB, _BB, _BB, _BB, _BB, _SP, _PU, _PU, _PU,
	_PU, _PU, _PU, _PU, _PU, _PU, _PU, _PU, _PU, _PU, _PU, _PU,
	XDI, XDI, XDI, XDI, XDI, XDI, XDI, XDI, XDI, XDI, _PU, _PU,
	_PU, _PU, _PU, _PU, _PU, XUP, XUP, XUP, XUP, XUP, XUP, _UP,
	_UP, _UP, _UP, _UP, _UP, _UP, _UP, _UP, _UP, _UP, _UP, _UP,
	_UP, _UP, _UP, _UP, _UP, _UP, _UP, _PU, _PU, _PU, _PU, _PU,
	_PU, XLO, XLO, XLO, XLO, XLO, XLO, _LO, _LO, _LO, _LO, _LO,
	_LO, _LO, _LO, _LO, _LO, _LO, _LO, _LO, _LO, _LO, _LO, _LO,
...
struct _tc_string tc_strings[32] = {
	...
	{ "cl",
	  &_term_clrpag,
	  0 }, /* String to clear the entire screen and put
	...
	{ "ks",
	  &_term_ks,
	  0 }, /* String to make the function keys transmit. */
	{ "ku",
	  &_term_ku,
	...
	{ "pc",
	  &_term_pc,
	  0 }, /* String containing character for padding. */
	{ "up",
	  &_term_up,
	...
	{ "vb",
	  &_visible_bell,
	  0 },			/* String to make the screen flash. */
	{ "vs", &_term_vs, 0 }, /* String to enhance the cursor. */
	{ "vi",
	  &_term_vi,
	  0 }, /* String to make the cursor invisible. */
	{ "ve",
	  &_term_ve,
	  0 }, /* String to return the cursor to normal. */
};
